...
// default network is Polygon if user is not connected
const NETWORK_TYPE_DEFAULT = chains.getChainInformation(137)?.type
...
function WalletContextProvider({ children }) {
  ...
  const wallet = useMemo(
    () => ({
      ...
      web3: walletWeb3,
      status,
      chainId: connected ? chainId : 137, // connect to Polygon if wallet is not connected
      connected,
